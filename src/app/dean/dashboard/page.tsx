...
import {
    ...
    Brain, Zap, Sparkles, ShieldCheck, PieChart as PieChartIcon
} from "lucide-react";
...
export default function DeanDashboard() {
    ...
    // NEW: Radar chart for department metrics
    ...
    // NEW: Multi-series area chart for department comparison
    const deptComparisonData = [
        { month: 'Aug', cse: 88, ece: 82, it: 85, mech: 78 },
        { month: 'Sep', cse: 90, ece: 85, it: 87, mech: 80 },
        { month: 'Oct', cse: 92, ece: 88, it: 89, mech: 82 },
        { month: 'Nov', cse: 91, ece: 86, it: 90, mech: 84 },
        { month: 'Dec', cse: 93, ece: 89, it: 91, mech: 85 },
    ];

    // NEW: Segmented bar for pass/fail distribution
    const examResultsData = [
        { dept: 'CSE', passed: 580, failed: 20 },
        { dept: 'ECE', passed: 420, failed: 30 },
        { dept: 'IT', passed: 350, failed: 25 },
        { dept: 'MECH', passed: 280, failed: 40 },
        { dept: 'CIVIL', passed: 180, failed: 20 },
    ];
    ...
    useEffect(() => {
        const generateRandomTrend = () => {
            ...
            return [
                ...
                { period: 'P5', attendance: base - 15, time: '13:30', predicted: base - 10 },
        ...
        <div className="space-y-6 pb-8">
            ...
            <Card className="border-none shadow-2xl bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-900 text-white overflow-hidden relative">
                ...
                <CardContent className="grid md:grid-cols-3 gap-6 relative z-10">
                    ...
                    <div className="bg-white/5 p-4 rounded-xl border border-green-500/30 backdrop-blur-sm hover:bg-white/10 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Total Faculty */}
                <Card className="relative overflow-hidden border-l-4 border-l-indigo-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Faculty</CardTitle>
                        <div className="p-3 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 shadow-lg">
                            <Users className="h-5 w-5 text-white" />
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.totalFaculty}</div>
                ...
                {/* Total Students */}
                <Card className="relative overflow-hidden border-l-4 border-l-green-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                {/* Departments */}
                <Card className="relative overflow-hidden border-l-4 border-l-purple-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-400">Departments</CardTitle>
                ...
                {/* At-Risk Students */}
                <Card className="relative overflow-hidden border-l-4 border-l-red-500 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.atRiskStudents}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="hover:shadow-lg transition-shadow border-t-4 border-t-blue-500 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-400">Placement Rate</CardTitle>
                        <Target className="h-5 w-5 text-blue-600" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.placementRate}%</div>
                        <Progress value={dashboardData.placementRate} className="h-2 mt-3" />
                        <p className="text-xs text-gray-500 mt-2">2024 Batch</p>
                    </CardContent>
                </Card>

                <Card className="hover:shadow-lg transition-shadow border-t-4 border-t-amber-500 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-400">Research Publications</CardTitle>
                        <Award className="h-5 w-5 text-amber-600" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.researchPublications}</div>
                        <p className="text-xs text-green-600 mt-2 font-medium flex items-center gap-1">
                            <TrendingUp className="h-3 w-3" />
                            +18 this quarter
                        </p>
                ...
                <Card className="hover:shadow-lg transition-shadow border-t-4 border-t-orange-500 dark:bg-gray-900">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-gray-600 dark:text-gray-400">Pending Approvals</CardTitle>
                        <Clock className="h-5 w-5 text-orange-600" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{dashboardData.pendingApprovals}</div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
                {/* Radar Chart - Institute Metrics */}
                <AnimatedRadarChart
                    data={departmentRadarData}
                    title="Institute Performance Overview"
                    description="Key metrics across all dimensions"
                    dataKey="value"
                    nameKey="metric"
                    height={300}
                />

                {/* Area Chart - Department Comparison */}
                <AnimatedAreaChart
                    data={deptComparisonData}
                    title="Department-wise Performance Trends"
                    description="Monthly performance comparison"
                    xAxisKey="month"
                    dataKeys={[
                        { key: 'cse', color: 'blue', name: 'CSE' },
                        { key: 'ece', color: 'purple', name: 'ECE' },
                        { key: 'it', color: 'green', name: 'IT' },
                        { key: 'mech', color: 'amber', name: 'MECH' },
                    ]}
                    height={300}
                />
            </div>

            {/* Segmented Bar Chart for Exam Results */}
            <AnimatedSegmentedBarChart
                data={examResultsData}
                title="Department-wise Exam Results"
                description="Pass vs Fail distribution by department"
                xAxisKey="dept"
                segments={[
            ...
            {/* Filter Bar */}
            <div className="bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-wrap items-center gap-4">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-9 pr-3 py-2 h-10 w-[240px] rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                    />
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* Attendance Visualization Section */}
                        ...
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                                <BarChart data={departmentPerformanceData}>
                                    ...
                                    />
                                    <Bar dataKey="performance" fill="url(#perfGradient)" radius={[8, 8, 0, 0]} animationDuration={1200} />
                                    <Bar dataKey="target" fill="#e0e7ff" radius={[8, 8, 0, 0]} animationDuration={1200} animationBegin={200} />
                                </BarChart>
                            </ResponsiveContainer>
                ...
                <div className="space-y-6">
                    ...
                    {/* Recent Activities */}
                    <Card className="border-t-4 border-t-indigo-500 hover:shadow-lg transition-shadow dark:bg-gray-900">
                        <CardHeader>
                            <CardTitle className="flex items-center gap-2 text-lg">
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {dashboardData.recentActivities.map((activity: any, i: number) => (
                                    <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                        <div className={`p-2 rounded-lg ${activity.type === 'faculty' ? 'bg-indigo-100 dark:bg-indigo-900/50' :
                                            activity.type === 'student' ? 'bg-green-100 dark:bg-green-900/50' :
                    ...
                    {/* Quick Actions */}
                    <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-indigo-200 dark:border-indigo-800 hover:shadow-lg transition-shadow">
                        <CardHeader>
                            <CardTitle className="text-indigo-700 dark:text-indigo-300 text-lg">Quick Actions</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            ...
                            <Link href="/dean/timetable/create">
                                <Button variant="outline" className="w-full justify-start gap-2 hover:bg-indigo-100 dark:hover:bg-indigo-900/50">
                            ...
                            <div className="space-y-3">
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">NAAC</span>
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">NBA (CSE)</span>
                                        <Badge className="bg-blue-600">Accredited</Badge>
                                    </div>
                                    <Progress value={88} className="h-2" />
                                </div>
                                <Link href="/accreditation">
                                    <Button variant="link" className="p-0 h-auto text-xs text-amber-700 dark:text-amber-300 mt-2">
                                        View Details <ArrowRight className="w-3 h-3 ml-1" />
                                    </Button>
                                </Link>
                            </div>
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            {dashboardData.facultyByDept.slice(0, 6).map((dept: any, i: number) => (
                                <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors">
                    ...
                    <CardContent>
                        <div className="space-y-3">
                            {dashboardData.studentsByDept.slice(0, 6).map((dept: any, i: number) => (
                                <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors">
                                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{dept.dept}</span>
