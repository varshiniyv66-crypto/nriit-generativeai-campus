...
import { BookOpen, GraduationCap, Calendar, Download, Clock, FileText, Phone, ChevronRight } from "lucide-react";
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
                        <h2 className="text-4xl md:text-5xl font-black text-[#0F172A]">Academic Affairs</h2>
